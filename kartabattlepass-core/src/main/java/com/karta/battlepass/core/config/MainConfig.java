...
public record MainConfig(
    ...
    public record RedisConfig(boolean enabled, @NotNull String uri, @NotNull Channels channels) {
        public record Channels(@NotNull String boosters, @NotNull String leaderboard) {}
    }
    ...
    public record DailyResetConfig(
            @JsonProperty("reset-time") @NotNull LocalTime resetTime, @NotNull ZoneId timezone) {}
    ...
    public record GuiConfig(@NotNull String theme, boolean sounds, boolean titles) {}

    public record PlaceholderConfig(@JsonProperty("cache-ms") long cacheMs) {}

    public record MetricsConfig(
            boolean bstats, @JsonProperty("log-performance") boolean logPerformance) {}

    public record FoliaConfig(boolean enabled // "auto" will be handled in logic
            ) {}
}
