...
public interface BoosterService {
     ...
     * @param playerUuid The UUID of the player to activate the booster for. If null, the booster is
     *     activated globally.
     * @return A {@link CompletableFuture} that completes with the {@link ActiveBooster} instance if
     *     successful.
     */
    @NotNull
    CompletableFuture<ActiveBooster> activateBooster(
     ...
     * @return A {@link CompletableFuture} that completes with a list of all relevant {@link
     *     ActiveBooster}s.
     */
    @NotNull
    ...
    /**
     * Calculates the total multiplier for a given booster type for a specific player. This takes
     * into account all active personal and global boosters and their stacking strategies.
     *
     * @param playerUuid The UUID of the player.
     * @param type The type of booster to calculate the multiplier for.
     * @return A {@link CompletableFuture} that completes with the final multiplier. A value of 1.0
     *     means no boost.
     */
    @NotNull
