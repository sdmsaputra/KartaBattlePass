...
public interface RewardService {
     ...
     *
     * @return A {@link CompletableFuture} that completes with a list of all {@link Tier} definitions.
     */
    @NotNull
     ...
     * @return A {@link CompletableFuture} that completes with {@code true} if the rewards have been claimed,
     *         {@code false} otherwise.
     */
    @NotNull
    CompletableFuture<Boolean> hasClaimedTier(@NotNull UUID playerUuid, int tierLevel, @NotNull PassType passType);

    /**
     * Claims all available rewards for a player up to their current tier.
     *
     * @param playerUuid The UUID of the player.
     * @return A {@link CompletableFuture} that completes when all available rewards have been granted.
     */
    @NotNull
     ...
     * <p>
     * This will fail if the player has not yet unlocked the tier or has already claimed it.
     *
     * @param playerUuid The UUID of the player.
