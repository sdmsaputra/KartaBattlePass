 ...
 * @param progress A map holding the player's current progress data. For a simple
 *                 "break N blocks" quest, this might be `{"value": 10}`. For multi-step
 *                 quests, it could be more complex.
