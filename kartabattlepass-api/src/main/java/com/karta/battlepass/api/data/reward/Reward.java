 ...
 * @param data A map containing the configuration for the reward.
 *             The structure of this map depends on the reward {@code type}.
 *             For example, a "COMMAND" type might have a "command" key with the command string.
