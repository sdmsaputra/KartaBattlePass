...
public interface LeaderboardService {
     ...
     * @return A {@link CompletableFuture} that completes with a list of {@link LeaderboardEntry}s
     *     for the requested page.
     */
    @NotNull
    CompletableFuture<List<LeaderboardEntry>> getLeaderboardPage(
     ...
     * @return A {@link CompletableFuture} that completes with a list of the top {@link
     *     LeaderboardEntry}s.
     */
    @NotNull
    CompletableFuture<List<LeaderboardEntry>> getLeaderboardSnapshot(
            @NotNull LeaderboardMetric metric, int limit);

    /**
     * Forces the leaderboard to be rebuilt from the data source. This is an expensive operation and
