...
public interface QuestService {
    ...
    /**
     * Registers a new custom quest type. This should be called by other plugins in their onEnable
     * method.
     *
    ...
    /**
     * Gets all available quests for a player in a specific category for the current period. This
     * takes into account any quests the player may have already completed if they are not
     * repeatable.
     *
     ...
     */
    @NotNull
    CompletableFuture<List<Quest>> getAvailableQuests(
     ...
     */
    @NotNull
    CompletableFuture<QuestProgress> getQuestProgress(
            @NotNull UUID playerUuid, @NotNull String questId);

    /**
     * Forces a player to complete a quest. This is an admin command and bypasses normal quest
     * logic.
     *
     * @param playerUuid The UUID of the player.
    ...
    /**
     * Processes a Bukkit event for a player to update their quest progress. This is intended to be
     * called by the quest listeners in the Bukkit module.
     *
    ...
    /**
     * Directly increments the progress of a quest for a player. This is intended for
     * non-event-driven quests like playtime.
     *
     * @param playerUuid The UUID of the player.
     * @param questId The ID of the quest.
     ...
     */
    @NotNull
    CompletableFuture<Void> incrementQuestProgress(
            @NotNull java.util.UUID playerUuid, @NotNull String questId, int amount);
}
