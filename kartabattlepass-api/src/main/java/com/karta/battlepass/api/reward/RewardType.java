 ...
 *
 * <p>Implement this interface to create a new type of reward that can be registered with the {@link
 * com.karta.battlepass.api.service.RewardService}.
 */
@FunctionalInterface
public interface RewardType {
     ...
     * @return A {@link CompletableFuture} that completes when the reward has been successfully
     *     given.
     */
    @NotNull
