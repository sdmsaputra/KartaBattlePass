...
public class PlayerServiceIntegrationTest {
    ...
    void setUp() {
        ...
        registry.register(
                com.karta.battlepass.api.service.SeasonService.class,
                new SeasonServiceImpl(new AtomicReference<>(null))); // Dummy
        registry.register(
                com.karta.battlepass.api.service.PassService.class,
                new PassServiceImpl(registry, scheduler, databaseManager.getJdbi()));
    }
    ...
    void testHandlePlayerJoin() {
        ...
        assertTrue(
                playerDao.findById(playerId).isPresent(),
                "Player should be inserted on first join");
        ...
        assertEquals(
                newPlayerName,
                profile.get().name(),
                "Player name should be updated on subsequent join");
    }
}
